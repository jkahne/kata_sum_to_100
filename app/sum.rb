class Sum
  ...
  def to_s
    ...
    str << @numbers[4]
    # inc every 3*3*3
    str << @operators[(@cx/(@operators.length*@operators.length*@operators.length)) % @operators.length]
    ...
    str << @operators[(@cx/(@operators.length*@operators.length)) % @operators.length]
    str << @numbers[6]
